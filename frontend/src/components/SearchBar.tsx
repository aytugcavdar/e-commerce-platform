...
const SearchBar: React.FC = () => {
    ...
    return (
        <div className="relative w-full" ref={dropdownRef}>
            {/* ... (Ana arama kutusu ve ikonlar aynı kalıyor) */}
                ...
                <AnimatePresence>
                    {showFilters && isExpanded && (
                        <motion.div
                            ...
                            className="absolute top-full left-0 right-0 mt-2 p-4 bg-white rounded-lg shadow-lg border border-gray-200 z-50"
                        >
            ...
            <AnimatePresence>
                {isDropdownOpen && (
                    <motion.div
                        ...
                        className={`absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-2xl border border-gray-200 z-40 overflow-hidden ${
                            isExpanded ? 'max-h-[80vh]' : 'max-h-96'
                        }`}
                        style={{ originY: 0 }}
                    >
                        {/* ... (Tüm dropdown içeriğiniz burada değişmeden kalıyor) */}
